    ...
    >
      ...
      >
        <div className="flex items-center gap-4">
          <div className={`p-2 rounded-xl transition-colors duration-300 ${isOpen
          ...
          <span className={`text-base font-semibold tracking-wide transition-colors duration-300 ${isOpen ? 'text-primary dark:text-[#00f2fe]' : 'text-charcoal dark:text-white/90 group-hover:text-primary dark:group-hover:text-[#00f2fe]'
            }`}>
            {title}
          </span>
        </div>
        ...
        >
          <ChevronDown
            className={`w-5 h-5 transition-colors ${isOpen ? 'text-primary dark:text-[#00f2fe]' : 'text-neutral-400 group-hover:text-primary dark:group-hover:text-[#00f2fe]'
              }`}
          />
        </motion.div>
      </button>
